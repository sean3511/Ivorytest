! function(e, t) {
    ...
    var u, v, f, m, g, b, w, y, x, E, T, S, C, M, P, z = {
            updateSize: function() {
                var e, t, i = this.$el;
        ...
        O = (u = a.navigator.platform, v = a.navigator.userAgent, f = {
            ios: !1,
            android: !1,
            androidChrome: !1,
            desktop: !1,
            ...
            if (!t.isTouchEvent || "touchmove" === o.type) {
                ...
                if (t.allowTouchCallbacks && this.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
                    ...
                    if (!(this.params.threshold && Math.sqrt(Math.pow(u, 2) + Math.pow(v, 2)) < this.params.threshold))
                        if (void 0 === t.isScrolling && (this.isHorizontal() && a.currentY === a.startY || this.isVertical() && a.currentX === a.startX ? t.isScrolling = !1 : u * u + v * v >= 25 && (c = 180 * Math.atan2(Math.abs(v), Math.abs(u)) / Math.PI, t.isScrolling = this.isHorizontal() ? c > s.touchAngle : 90 - c > s.touchAngle)), t.isScrolling && this.emit("touchMoveOpposite", o), void 0 === t.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (t.startMoving = !0)), t.isScrolling) t.isTouched = !1;
    ...
    var F = {
            ...
            events: {
                attachEvents: function() {
                    var e = this.params,
                        ...
                        s = this.el,
                        a = this.wrapperEl;
                    this.onTouchStart = A.bind(this), this.onTouchMove = G.bind(this), this.onTouchEnd = H.bind(this), e.cssMode && (this.onScroll = X.bind(this)), this.onClick = N.bind(this);
                    var r = !!e.nested;
                    if (!h.touch && h.pointerEvents) s.addEventListener(t.start, this.onTouchStart, !1), i.addEventListener(t.move, this.onTouchMove, r), i.addEventListener(t.end, this.onTouchEnd, !1);
                        ...
                        if (h.touch) {
                            ...
                            s.addEventListener(t.start, this.onTouchStart, n), s.addEventListener(t.move, this.onTouchMove, h.passiveListener ? {
                                passive: !1,
                                capture: r
                            } : r), s.addEventListener(t.end, this.onTouchEnd, n), t.cancel && s.addEventListener(t.cancel, this.onTouchEnd, n), V || (i.addEventListener("touchstart", Y), V = !0)
                        }(e.simulateTouch && !O.ios && !O.android || e.simulateTouch && !h.touch && O.ios) && (s.addEventListener("mousedown", this.onTouchStart, !1), i.addEventListener("mousemove", this.onTouchMove, r), i.addEventListener("mouseup", this.onTouchEnd, !1))
                    }(e.preventClicks || e.preventClicksPropagation) && s.addEventListener("click", this.onClick, !0), e.cssMode && a.addEventListener("scroll", this.onScroll), e.updateOnWindowResize ? this.on(O.ios || O.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", B, !0) : this.on("observerUpdate", B, !0)
                },
                detachEvents: function() {
                    ...
                    if (!h.touch && h.pointerEvents) s.removeEventListener(t.start, this.onTouchStart, !1), i.removeEventListener(t.move, this.onTouchMove, r), i.removeEventListener(t.end, this.onTouchEnd, !1);
                        ...
                        }(e.simulateTouch && !O.ios && !O.android || e.simulateTouch && !h.touch && O.ios) && (s.removeEventListener("mousedown", this.onTouchStart, !1), i.removeEventListener("mousemove", this.onTouchMove, r), i.removeEventListener("mouseup", this.onTouchEnd, !1))
                    }(e.preventClicks || e.preventClicksPropagation) && s.removeEventListener("click", this.onClick, !0), e.cssMode && a.removeEventListener("scroll", this.onScroll), this.off(O.ios || O.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", B)
                }
            },
            breakpoints: {
        ...
        q = function(e) {
            function t() {
                ...
                1 === r.length && r[0].constructor && r[0].constructor === Object ? a = r[0] : (s = (i = r)[0], a = i[1]), a || (a = {}), a = d.extend({}, a), s && !a.el && (a.el = s), e.call(this, a), Object.keys(W).forEach((function(e) {
                ...
                var p = d.extend({}, F);
                l.useModulesParams(p), l.params = d.extend({}, p, R, a), l.originalParams = d.extend({}, l.params), l.passedParams = d.extend({}, a), l.$ = n;
                var c = n(l.params.el);
                if (s = c[0]) {
                    if (c.length > 1) {
                        var u = [];
        ...
        pe = {
            ...
            setTranslate: function(e, t) {
                ...
                if (Array.isArray(r))
                    for (var o = 0; o < r.length; o += 1) r[o] !== t && r[o] instanceof q && n(r[o]);
                else r instanceof q && t !== r && n(r)
            },
            setTransition: function(e, t) {
                var i, s = this,
                ...
                if (Array.isArray(a))
                    for (i = 0; i < a.length; i += 1) a[i] !== t && a[i] instanceof q && r(a[i]);
                else a instanceof q && t !== a && r(a)
            }
        },
        ce = {
        ...
        ge = {
            setTranslate: function() {
                ...
                if (i.css({
                    ...
                    } var $ = U.isSafari || U.isWebView ? -l / 2 : 0;
    ...
    return void 0 === q.use && (q.use = q.Class.use, q.installModule = q.Class.installModule), q.use(xe), q
}));
(function(o, d, l) {
    try {
